...
def get_num_classes(dataset_name: str) -> int:
    ...
    if dataset_name in ["mnist", "cifar10", "nmnist", "nmiste"]: # Neuromorphic Datasets
        num_classes = 10
    ...
    elif dataset_name in ["gesture", "dvs128gesture"]:
        num_classes = 11
...
def get_input_shape(dataset_name: str) -> Tuple[int, int, int]:
    ...
    # Neuromorphic Datasets (we treat them as frames)
    elif dataset_name in ["nmnist", "nmiste"]:
        input_height = 34
        input_width = 34
        input_channel = 2
    elif dataset_name in ["gesture", "dvs128gesture"]:
